function AfterSaleModule({ careTasks=[], onUpdateTasks, orders=[], customers=[], currentUser, currentRole, pushNotif }) {
  ...
  const TYPE_LABEL={call:"Gọi điện",review:"Xin review",birthday:"Sinh nhật",pre_trip:"Nhắc trước tour",other:"Khác"};
  const TYPE_ICON={call:"📞",review:"⭐",birthday:"🎂",pre_trip:"🧳",other:"📌"};
